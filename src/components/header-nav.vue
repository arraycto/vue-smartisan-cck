  ...
  <div id="header">
    <div class="nav-global">
      <div class="container">
        ...
        <ul class="nav-list">
          <li><a href="javascript:;">商城菜单一</a></li>
          <li><a href="javascript:;">商城菜单二</a></li>
          <li><a href="javascript:;">商城菜单三</a></li>
          <li><a href="javascript:;">商城菜单四</a></li>
          <li><a href="javascript:;">商城菜单五</a></li>
          <li><a href="javascript:;">商城菜单六</a></li>
        </ul>
      </div>
    </div>
    <div class="nav-sub">
